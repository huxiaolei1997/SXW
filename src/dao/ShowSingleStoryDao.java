...
public class ShowSingleStoryDao {
	public List<ViewStory> querySingleStory(String id) throws Exception {
		List<ViewStory> singleStory = new ArrayList<ViewStory>();
