...
<body data-type="generalComponents">
				...
				<div class="tpl-block">
					...
					<div class="am-g">
						<div class="tpl-form-body tpl-form-line">
							<form class="am-form tpl-form-line-form" action="<%=path%>/test2/addExperience" method="post" id="addExperience" name="addExperience" enctype="multipart/form-data">
								<div class="am-form-group">
									...
									<div class="am-u-sm-9">
										<input type="text" class="tpl-form-input" id="experTitle"
											placeholder="请输入标题文字" name="experTitle" maxlength="20"> <small>请填写标题文字最多20字。</small>
									</div>
								</div>
								<div class="am-form-group">
									...
									<div class="am-u-sm-9">
										<div class="am-form-group am-form-file">
											<div class="tpl-form-file-img">
											   <img alt="" src="../img/a5.png" id="previewImg" style="width:300px;height:200px;">
											</div>
	...
	<script type="text/javascript">
		...
		function addViewStory() {
			...
			if (experTitle == '' || experTitle.replace(reg2, '') == '') {
				swal(
					'标题',
					'不能为空！',
					'warning'
