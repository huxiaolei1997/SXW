			...
			<div class="tpl-left-nav-list">
				<ul class="tpl-left-nav-menu">
						...
						<ul class="tpl-left-nav-sub-menu">
							<li><a href="<%=path%>/test2/pagerXiangJu"> <i
									...
									class="am-icon-star tpl-left-nav-content-ico am-fr am-margin-right"></i>
									 ...
									 <a href="<%=path%>/test2/pagerExperience"> <i class="am-icon-angle-right"></i>
											<span>体验管理</span>
					...
					<li class="tpl-left-nav-item"><a href="javascript:;"
						...
						<ul class="tpl-left-nav-sub-menu">
							<li><a href="<%=path%>/test2/pagerUser"> <i class="am-icon-angle-right"></i>
									<span>用户管理</span> <i
									class="am-icon-star tpl-left-nav-content-ico am-fr am-margin-right"></i>
...
<li class="tpl-left-nav-item"><a href="<%=path%>/test2/showAccessIpAddress" class="nav-link"> <i class="am-icon-bar-chart"></i> <span>网站访客统计</span>
					...
					<li class="tpl-left-nav-item"><a href="<%=path%>/test2/loginOut"
						class="nav-link tpl-left-nav-link-list"> <i
				...
				<div class="tpl-block">
					...
					<div class="am-g">
						<div class="tpl-form-body tpl-form-line">
							<form class="am-form tpl-form-line-form" action="<%=path%>/test2/updateViewStory" method="post" id="uploadimage" name="uploadimage" enctype="multipart/form-data">
								<div class="am-form-group">
									<label for="title" class="am-u-sm-3 am-form-label">标题
										<span class="tpl-form-line-small-title">Title</span>
									</label>
									<div class="am-u-sm-9">
										<input type="text" class="tpl-form-input" id="title"
											placeholder="请输入标题文字" name="title" maxlength="20" value="${viewTitle}"> <small>请填写标题文字10-20字左右。</small>
									</div>
								</div>
                                	<div class="am-form-group">
									...
									<div class="am-u-sm-9">
										<input type="text" class="tpl-form-input" id="introduction"
											placeholder="请输入景点介绍文字"  name="introduction" maxlength="200" value="${introduction}"> <small>请填写景点介绍文字10-100字左右。</small>
									</div>
								</div>
								<div class="am-form-group">
									...
									<div class="am-u-sm-9">
										<input type="text" id="addtime" name="addtime" class="am-form-field tpl-form-no-bg"
											placeholder="发布时间" data-am-datepicker="" readonly value="${fn:substring(addtime,0,10)}"/> <small>发布时间为必填</small>
									</div>
								</div>
									...
									<div class="am-u-sm-9">
										<div class="am-form-group am-form-file">
											<div class="tpl-form-file-img">
											   <img alt="" src="<%=path%>${imageUrl}" id="previewImg" style="width:300px;height:200px;">
											</div>
								...
								<div class="am-form-group">
									<div class="am-u-sm-9 am-u-sm-push-3">
										<button type="button"
											class="am-btn am-btn-primary tpl-btn-bg-color-success" onclick="addViewStory()">提交</button>
									</div>
								</div>
							</form>
